...
public record KnowledgeDocument(
        ...
        int publishedVersion, String sourceScope, int sourcePriority, String sourceProvider,
        String sourceIdentifier, String sourceUrl, String sourceVenue, Integer sourceYear,
